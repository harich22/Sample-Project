		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sify Employee details",
									"targetURL": "#SifyEmployeedetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SifyEmployeedetails-display": {
								"semanticObject": "SifyEmployeedetails",
								"action": "display",
								"description": "Sify Employee details ",
								"title": "Sify Employee details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hari.app.Zsify_emp",
									"url": sap.ui.require.toUrl("hari/app/Zsify_emp")
								}
							}
						}
					}
